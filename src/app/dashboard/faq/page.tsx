    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 lg:px-10 pt-0">
          ...
          <div className="bg-primary py-10 rounded-lg">
            <Accordion
              collapsible
              type="single"
            ...
            >
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  adaptées à une large gamme de clients, y compris les
                  particuliers, les entreprises de taille moyenne et les grandes
                  entreprises.
                </AccordionContent>
              </AccordionItem>
                ...
                <AccordionContent>
                  <ol className="space-y-2">
                    <li>
                      ...
                      Sélectionnez un pack d’investissement adapté à vos
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  ...
                  <ul className="pl-5">
                    ...
                    <li>
                      - Les placements en crypto-monnaie et autres actifs
                      numériques
                    </li>
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent>
                  <p className="font-bold mb-2">
                    Les rendements varient selon le montant investi et la durée
                    du placement. Par exemple :
                  </p>
                  <ul className="pl-5">
                    <li>
                      - Avec 50,000 F CFA dans un Pack Start (7 jours), vous
                      obtenez 60,000 F CFA.
                    </li>
                    <li>
                      - Avec 1,000,000 F CFA dans un Pack Premium (30 jours),
                      vous obtenez 1,750,000 F CFA.
                    </li>
                    <li>
                      - Consultez notre tableau complet des rendements pour plus
                      de détails.
                    </li>
                  </ul>
                </AccordionContent>
              ...
              <AccordionItem value="item-7">
                ...
                <AccordionContent>
                  ...
                  <ul className="pl-5">
                    ...
                    <li>
                      - Assurer un suivi rigoureux des placements pour garantir
              ...
              <AccordionItem value="item-8">
                ...
                <AccordionContent>
                  Comme tout investissement, il existe des risques, notamment
                  les fluctuations des marchés et les aléas économiques. HARVEX
                  GROUPE met en place des stratégies solides pour minimiser ces
                  risques.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-9">
                ...
                <AccordionContent>
                  ...
                  <ol className="pl-5">
                    ...
                    <li>
                      3. Effectuez votre investissement et laissez-nous gérer
                      vos placements.
                    </li>
                  </ol>
                </AccordionContent>
              ...
              <AccordionItem value="item-10">
                ...
                <AccordionContent>
                  <p className="font-bold mb-2">
                    Nous offrons une plateforme en ligne sécurisée où vous
                    pouvez consulter :
                  </p>
                  <ul className="pl-5">
              ...
              <AccordionItem value="item-11">
                ...
                <AccordionContent>
                  ...
                  veuillez nous contacter immédiatement via notre support client
                  afin que nous puissions prendre les mesures nécessaires pour
              ...
              <AccordionItem value="item-12">
                ...
                <AccordionContent>
                  ...
                  peuvent s&apos;appliquer selon le produit
                  d&apos;investissement. Veuillez consulter les termes
                  spécifiques de chaque produit ou contacter le support client
              ...
              <AccordionItem value="item-13">
                ...
                <AccordionContent>
                  Oui, nous sommes toujours à la recherche de talents
                  passionnés. Consultez notre page Carrières pour découvrir les
                  postes disponibles.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-15">
                ...
                <AccordionContent>
                  ...
                  société spécialisée dans le placement de biens, l’immobilier,
                  les énergies renouvelables et la crypto-monnaie. Nous offrons
                  des solutions d’investissement adaptées à une large gamme de
                  clients, y compris les particuliers, les entreprises de taille
