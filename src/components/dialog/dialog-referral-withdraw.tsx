...
type DialogReferralWithdrawProps = {
  account?: AccountBalance;
};

export function DialogReferralWithdraw(props: DialogReferralWithdrawProps) {
  const { account } = props;
    ...
    >
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Retirez votre solde de parrainage vers votre portefeuille externe.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
